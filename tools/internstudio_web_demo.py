...
@st.cache_resource
def load_model():
    model = AutoModelForCausalLM.from_pretrained('~/model/Meta-Llama-3-8B-Instruct').cuda()
    tokenizer = AutoTokenizer.from_pretrained('~/model/meta-llama/Meta-Llama-3-8B-Instruct', trust_remote_code=True)
